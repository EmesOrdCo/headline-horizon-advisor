...
import { ArrowLeft, TrendingUp, TrendingDown, Calendar, Bot, BarChart3 } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-8">
            ...
            <TabsContent value="data" className="space-y-6">
              <AllDataTab symbol={stockSymbol} stockInfo={stockInfo} />
            </TabsContent>
          </Tabs>
        </div>
      </div>
...
const AllDataTab = ({ symbol, stockInfo }: { symbol: string; stockInfo: any }) => {
  return (
